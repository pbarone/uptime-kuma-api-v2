...
reported **privately** to the maintainer using GitHub's private reporting:
[open a private report](https://github.com/pbarone/uptime-kuma-api2/security/advisories/new)
(the same confidential channel used for security reports — select it for
conduct matters as well). Please do not report violations in public issues.
